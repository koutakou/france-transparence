...
```
38 sources open data officielles (data.gouv.fr, DILA, AN, Sénat, HATVP, DGFiP, OFGL, CNCCFP, Eurostat, DREES, Direction du Budget…) — catalogue vivant : `/donnees`
...
ft-fraicheur         # fraîcheur RÉELLE des 38 sources amont (--json, --silencieux)
