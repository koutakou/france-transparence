...
```
41 sources open data officielles (data.gouv.fr, DILA, AN, Sénat, HATVP, DGFiP, OFGL, CNCCFP, Eurostat, DREES, INSEE, Direction du Budget…) — catalogue vivant : `/donnees`
...
ft-fraicheur         # fraîcheur RÉELLE des 41 sources amont (--json, --silencieux)
