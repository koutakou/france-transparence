...
```
36 sources open data officielles (data.gouv.fr, DILA, AN, Sénat, HATVP, DGFiP, OFGL, CNCCFP, Eurostat, DREES…) — catalogue vivant : `/donnees`
...
ft-fraicheur         # fraîcheur RÉELLE des 36 sources amont (--json, --silencieux)
