...
```
30 sources open data officielles (data.gouv.fr, DILA, AN, Sénat, HATVP, DGFiP, OFGL, CNCCFP…)
...
ft-fraicheur         # fraîcheur RÉELLE des 30 sources amont (--json, --silencieux)
