...
export default async function FinancementPage() {
  ...
  const ressourcesParts = ressources2024
    ? [
        {
          // Libellé explicite : ce total inclut les « autres aides publiques »,
          // alors que la tuile « Aide inscrite aux comptes » plus haut ne
          // compte que les fractions 1 et 2. Sans cette précision, la page
          // affiche deux montants différents pour ce qu'un lecteur prend pour
          // la même chose.
          libelle: "Aide publique (fractions 1 + 2 et autres)",
          valeur: ressources2024.aide_publique,
        },
        {
        ...
        {ressources2024 ? (
          <>
            ...
            <p className="mt-2 text-xs text-ink-muted">
              Ce total agrège les deux fractions <em>et</em> les autres aides
              publiques
              {aide2024
                ? ` (${enMillions(aide2024.autres_aides_publiques, 2)} en 2024)`
                : ""}
              , à la différence de la tuile «&nbsp;Aide inscrite aux comptes
              2024 par les partis&nbsp;» en haut de page
              {aide2024 ? ` (${enMillions(aide2024.aide_f1_f2, 2)})` : ""}, qui ne
              compte que les fractions 1 et 2. Les deux montants figurent sur
              cette page&nbsp;: ils ne portent pas sur le même périmètre.
            </p>
            <VueTableau>
