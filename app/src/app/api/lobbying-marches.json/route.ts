...
export async function GET() {
  ...
  return NextResponse.json({
    meta: {
      description:
        "Croisement du répertoire HATVP des représentants d'intérêts et des marchés publics (DECP consolidées), joints sur le SIREN. Périmètre de référence : marchés HORS accords-cadres (le montant notifié d'un accord-cadre est un maximum contractuel, pas une dépense ; les accords-cadres sont fournis à part). Montants = montant retenu écrêté à 100 M€ par marché, puis réparti à parts égales entre co-titulaires (la source ne les ventile pas) ; marchés sans montant renseigné comptés mais exclus des sommes ; le sous-total « hors montants suspects » est une BORNE BASSE, le drapeau n'ayant pas été audité marché par marché. Snapshot statique régénéré à chaque build.",
      avertissement:
